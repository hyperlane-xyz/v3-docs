...
Note, by default the explorer will only find message on [core Hyperlane chains](./reference/domains). To view messages send to and/or from other chains, see [configuring PI Chains](./guides/developer-tips/configuring-pi-chains.mdx).
