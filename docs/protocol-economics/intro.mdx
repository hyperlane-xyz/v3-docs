...
- **Streak Tiers**: HyperStreak has 4 tiers. The longer a user maintains their streak, the higher the tier (Tier 4) they achieve. Each tier provides a boost to the user’s reward.
