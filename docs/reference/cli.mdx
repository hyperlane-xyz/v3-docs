...
- `--overrides`: Set an additional path for overrides to the default registry data
...
By default, the CLI will pull chain metadata and contract addresses from the [default Hyperlane Registry](https://github.com/hyperlane-xyz/hyperlane-registry) but will write new configs and deployments to your local filesystem. For more information see the [Registries page](/docs/reference/registries.mdx).