...
For convenience, [relayers](../../operate/run-relayer.mdx "mention") watch for dispatched messages and will submit process transactions on behalf of the message sender if they receive sufficient payment on the origin chain. We refer to this as *interchain gas payment*.
