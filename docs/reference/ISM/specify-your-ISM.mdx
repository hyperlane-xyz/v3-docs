...
```solidity file=<rootDir>/static/contracts/interfaces/IInterchainSecurityModule.sol
```
...
```solidity file=<rootDir>/static/contracts/interfaces/IInterchainSecurityModule.sol#L31-L33
```
...
```solidity file=<rootDir>/static/contracts/interfaces/IInterchainSecurityModule.sol#L21
```

This is used to signal to the Relayer how to encode `_metadata`. ISMs **must** return one of the supported module types.

```solidity file=<rootDir>/static/contracts/interfaces/IInterchainSecurityModule.sol#L5-L14
```
