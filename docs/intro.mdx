...
2. [Interchain accounts](https://docs.hyperlane.xyz/docs/reference/applications/interchain-account), which allows an account on one chain (e.g. a DAO) to make smart contract calls on remote chains
