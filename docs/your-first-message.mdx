...
5. For destination domain, enter `$DESTINATION_DOMAIN`. You could use `137` to send to mainnet Polygon, or see other [domains](https://docs.hyperlane.xyz/docs/resources/domains). 
