...
![Get excited](/img/kurtosis-get-excited.png)
...
![Example Configuration One](/img/kurtosis-example-config-one.png)

![Example Configuration Two](/img/kurtosis-example-config-two.png)
...
![Success](/img/kurtosis-success.png)

You can see information about your relayer and validator deployment, including logs, by navigating to the `Overview` tab.

![Enclave Overview](/img/kurtosis-enclave-overview.png)

![Validator Logs](/img/kurtosis-validator-logs.png)
