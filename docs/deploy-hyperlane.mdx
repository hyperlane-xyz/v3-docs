...
Currently core self-relay only works from **an existing origin chain** (e.g. Fuji) **to your custom chain**. When dispatch is successful, you should see that the message was self-relayed!
...
2. Select the chains you want to set up a warp route between, e.g.  `yourchain, fuji`
