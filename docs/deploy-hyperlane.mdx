...
本指南涵盖从新 EVM 链发送第一条链间消息。如果您想部署到 Cosmos 应用程序链，请遵循本社区提交的[指南](https://github.com/many-things/cw-hyperlane/blob/25a31818e9bf909875ab091f3884ee71bd25814f/DEPLOYMENT.md)。

在本指南结束时，您将部署并配置好邮箱智能合约和链外代理，允许开发者向您的链发送链间消息或从您的链发送链间消息。
