...
Staking and slashing allow economic security to be added to ISMs that rely on validator signatures, including [Multisig ISM](multisig-ISM.mdx) and Optimistic ISM.
...
[Interchain Security Modules](modular-security.mdx) that depend on signatures from these validators benefit from the additional economic security provided by staking and slashing.
...
### EigenLayer AVS
Hyperlane will be available as an EigenLayer AVS at launch, see this blog post for more information on [design](https://medium.com/hyperlane/modular-economic-security-bridge-disaster-insurance-5b837f366a6a).
