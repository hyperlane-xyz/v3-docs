...
Developers can compose a Wormhole ISM with a [multisig-ism.md](multisig-ISM.mdx "mention")using an [aggregation-ism.md](aggregation-ISM.mdx "mention") to require that m of n Hyperlane validators **and** 13-of-19 Wormhole guardians verify a message.
