...
Developers can compose a Wormhole ISM with a [MultisigISM](multisig-ISM.mdx "mention") using an [AggregationISM](aggregation-ISM.mdx "mention") to require that m of n Hyperlane validators **and** 13-of-19 Wormhole guardians verify a message.
