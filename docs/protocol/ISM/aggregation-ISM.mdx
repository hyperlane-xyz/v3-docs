...
For example, a custom implementation could require that low value messages be verified by a [Multisig ISM](multisig-ISM.mdx), and require that high value messages _also_ be verified by a [Wormhole ISM](./third-party-ISMs/wormhole-ISM.mdx).
