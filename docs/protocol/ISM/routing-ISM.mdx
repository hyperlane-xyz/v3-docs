...
This ISM simply switches security models depending on the origin chain of the message. A simple use case for this is to use different [MultisigISM](multisig-ISM.mdx) validator sets for each chain.
