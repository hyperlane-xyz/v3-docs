...
2. Use this gas token to enable fast native transfers, instead of long wait times for settlement via rollup bridges.
...
Use your L2's rollup bridge to transfer 100% of the `ETH` receipt token from ethereum to yourchain.
