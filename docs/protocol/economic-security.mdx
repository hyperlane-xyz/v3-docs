...
Staking and slashing allow economic security to be added to ISMs that rely on validator signatures, including [Multisig ISM](./ISM/multisig-ISM.mdx) and Optimistic ISM.
...
[Interchain Security Modules](../category/interchain-security-modules) that depend on signatures from these validators benefit from the additional economic security provided by staking and slashing.
