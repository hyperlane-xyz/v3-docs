...
[Interchain Security Modules](../protocol/ISM/modular-security.mdx) that depend on signatures from these validators benefit from the additional economic security provided by staking and slashing.
