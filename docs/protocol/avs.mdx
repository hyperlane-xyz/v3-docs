...
Since both slashing and reward payments aren't live yet, registration and operation does not mean that the signatures actually secure messages until setup in an ISM.
