...
| `--chains.[origin chain name].rpcurls.0.http` | The RPC URL of the node for the chain you are validating. Note Polygon mainnet requires an RPC URL of an archive node e.g. `--chains.ethereum.rpcurls.0.http` or `--chains.polygon.rpcurls.0.http`                                                                                                                          |
