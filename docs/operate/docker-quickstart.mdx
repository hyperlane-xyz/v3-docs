...
:::tip
**Running Multiple Validators**: Running multiple validators improves reliability and ensures message validation continues even if one fails. Learn more about the setup and requirements [here](./validators/run-validators.mdx#running-multiple-validators).
:::
