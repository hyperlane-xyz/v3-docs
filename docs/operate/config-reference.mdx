...
<TabItem value="env" label="As Env">
```sh
export HYP_CHAINS_${CHAIN_NAME}_FINALITY_BLOCKS="$FINALITY_BLOCKS"
export HYP_CHAINS_ETHEREUM_FINALITY_BLOCKS=20
```
</TabItem>
...
<TabItem value="env" label="As Env">
```sh
export HYP_CHAINS_${CHAIN_NAME}_ADDRESSES_MAILBOX="$MAILBOX_ADDRESS"
export HYP_CHAINS_ETHEREUM_ADDRESSES_MAILBOX="0x35231d4c2D8B8ADcB5617A638A0c4548684c7C70"
```
</TabItem>
...
<TabItem value="env" label="As Env">
```sh
export HYP_CHAINS_${CHAIN_NAME}_ADDRESSES_INTERCHAIN_GAS_PAYMASTER="$IGP_ADDRESS"
export HYP_CHAINS_ETHEREUM_ADDRESSES_INTERCHAIN_GAS_PAYMASTER="0x6cA0B6D22da47f091B7613223cD4BB03a2d77918"
```
</TabItem>
...
<TabItem value="env" label="As Env">
```sh
export HYP_CHAINS_${CHAIN_NAME}_ADDRESSES_VALIDATOR_ANNOUNCE="$VALIDATOR_ANNOUNCE_ADDRESS"
export HYP_CHAINS_ETHEREUM_ADDRESSES_VALIDATOR_ANNOUNCE="0x9bBdef63594D5FFc2f370Fe52115DdFFe97Bc524"
```
</TabItem>
...
<TabItem value="env" label="As Env">
```sh
export HYP_CHAINS_${CHAIN_NAME}_CONNECTION_TYPE="url"
export HYP_CHAINS_ETHEREUM_CONNECTION_TYPE="httpFallback"
```
</TabItem>
...
<TabItem value="env" label="As Env">
```sh
export HYP_CHAINS_${CHAIN_NAME}_CONNECTION_URL="$CONNECTION_URL"
export HYP_CHAINS_ETHEREUM_CONNECTION_URL="http://127.0.0.1:8545"
```
</TabItem>
...
<TabItem value="env" label="As Env">
```sh
export HYP_CHAINS_${CHAIN_NAME}_CONNECTION_URLS="$CONNECTION_URLS"
export HYP_CHAINS_ETHEREUM_CONNECTION_URLS="http://127.0.0.1:8545,http://127.0.0.1:8546,http://127.0.0.1:8547"
```
</TabItem>
...
<TabItem value="env" label="As Env">
```sh
export HYP_DESTINATIONCHAINNAMES="arbitrum,ethereum,bsc"
```
</TabItem>
