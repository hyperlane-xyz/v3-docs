...
<TabItem value="env" label="As Env">
  ```bash export
  CONFIG_FILES='./config/ethereum/my-config.json,./config/ethereum/my-validator-config.json'
  ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```bash 
  export HYP_CHAINS_${CHAIN_NAME}_NAME="$DOMAIN_NAME" export
...
<TabItem value="env" label="As Env">
  ```sh export HYP_CHAINS_${CHAIN_NAME}_DOMAIN="$DOMAIN_NAME" export
...
<TabItem value="env" label="As Env">
  ```sh export HYP_CHAINS_${CHAIN_NAME}_MAILBOX="$MAILBOX_ADDRESS" export
  HYP_CHAINS_ETHEREUM_MAILBOX="0x35231d4c2D8B8ADcB5617A638A0c4548684c7C70" ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```sh export HYP_CHAINS_${CHAIN_NAME}_INTERCHAINGASPAYMASTER="$IGP_ADDRESS"
  export
  HYP_CHAINS_ETHEREUM_INTERCHAINGASPAYMASTER="0x6cA0B6D22da47f091B7613223cD4BB03a2d77918"
  ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```sh export HYP_CHAINS_${CHAIN_NAME}
...
<TabItem value="env" label="As Env">
  ```sh export HYP_CHAINS_${CHAIN_NAME}
  _MERKLETREEHOOK="$MERKLE_TREE_HOOK_ADDRESS" export HYP_CHAINS_ETHEREUM_MERKLETREEHOOK="0x48e6c30B97748d1e2e03bf3e9FbE3890ca5f8CCA"
  ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```bash export HYP_CHAINS_${CHAIN_NAME}_SIGNER_*="...." ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```bash export HYP_CHAINS_${CHAIN_NAME}_SIGNER_TYPE="hexKey" ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```bash export HYP_CHAINS_${CHAIN_NAME}
  _SIGNER_ID="alias/validator-signer-ethereum" ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```bash export HYP_CHAINS_${CHAIN_NAME}_SIGNER_REGION="us-east-1" ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```sh export HYP_CHAINS_${CHAIN_NAME}_PROTOCOL="ethereum" export
  HYP_CHAINS_ARBITRUM_PROTOCOL="ethereum" ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```sh export HYP_CHAINS_${CHAIN_NAME}_RPCCONSENSUSTYPE="single" export
  HYP_CHAINS_ETHEREUM_RPCCONSENSUSTYPE="single" ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```sh export HYP_CHAINS_${CHAIN_NAME}_CUSTOMRPCURLS="$CONNECTION_URLS" export
  HYP_CHAINS_ETHEREUM_RPCURLS_2_HTTPS="http://127.0.0.1:8545,http://127.0.0.1:8546,http://127.0.0.1:8547"
  ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```sh export HYP_CHAINS_${CHAIN_NAME}_RPCURLS_0_HTTPS="$CONNECTION_URL_0"
  export HYP_CHAINS_${CHAIN_NAME}_RPCURLS_1_HTTPS="$CONNECTION_URL_1" export
  HYP_CHAINS_${CHAIN_NAME}_RPCURLS_2_HTTPS="$CONNECTION_URL_2" export
  HYP_CHAINS_ETHEREUM_RPCURLS_0_HTTPS="http://127.0.0.1:8545" export
  HYP_CHAINS_ETHEREUM_RPCURLS_1_HTTPS="http://127.0.0.1:8546" export
  HYP_CHAINS_ETHEREUM_RPCURLS_2_HTTPS="http://127.0.0.1:8547" ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ...
  export HYP_CHAINS_COSMOS_GRPCURLS_2_HTTPS="http://127.0.0.1:8545,http://127.0.0.1:8546,http://127.0.0.1:8547"
  ```
</TabItem>
...
```json
{
    "chains": {
        "cosmos": {
            "rpcUrls": "<connection_urls>",
            "grpcUrls": "http://127.0.0.1:8545,http://127.0.0.1:8546,http://127.0.0.1:8547"
        }
    }
}
```
...
<TabItem value="env" label="As Env">
  ```sh export HYP_CHAINS_${CHAIN_NAME}_INDEX_FROM=0 export
  HYP_CHAINS_ETHEREUM_INDEX_FROM=16271503 ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```sh export HYP_CHAINS_${CHAIN_NAME}_INDEX_CHUNK=1999 export
  HYP_CHAINS_ETHEREUM_INDEX_CHUNK=1999 ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```bash export HYP_DEFAULTSIGNER_*="...." ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```bash export HYP_DEFAULTSIGNER_TYPE="hexKey" ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```bash export
  HYP_DEFAULTSIGNER_KEY="8166f546bab6da521a8369cab06c5d2b9e46670292d85c875ee9ec20e84ffb61"
  ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```bash export HYP_DEFAULTSIGNER_ID="alias/validator-signer-ethereum" ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```bash export HYP_DEFAULTSIGNER_REGION="us-east-1" ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```sh export HYP_METRICSPORT=9090 ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```bash export HYP_LOG_FORMAT="pretty" ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```bash export HYP_LOG_LEVEL="info" ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```sh export HYP_ORIGINCHAINNAME="ethereum" ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```bash export HYP_VALIDATOR_TYPE="hexKey" ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```bash export
  HYP_VALIDATOR_KEY="8166f546bab6da521a8369cab06c5d2b9e46670292d85c875ee9ec20e84ffb61"
  ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```bash export HYP_VALIDATOR_ID="alias/validator-signer-ethereum" ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```bash export HYP_VALIDATOR_REGION="us-east-1" ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```sh export HYP_CHECKPOINTSYNCER_TYPE="localStorage" ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```sh export HYP_CHECKPOINTSYNCER_PATH="/tmp/syncer" ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```sh export HYP_CHECKPOINTSYNCER_BUCKET="signatures-ethereum" ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```sh export HYP_CHECKPOINTSYNCER_FOLDER="signatures-ethereum" ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```sh export HYP_CHECKPOINTSYNCER_REGION="us-east-1" ```
</TabItem>
...
**Description:** How frequently the validator should check for new checkpoints in seconds? See also [latencies](../reference/latencies.mdx).
...
<TabItem value="env" label="As Env">
  ```sh export HYP_RELAYCHAINS="arbitrum,ethereum,bsc" ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```sh export HYP_TRANSACTIONGASLIMIT="250000000" ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```sh export HYP_SKIPTRANSACTIONGASLIMITFOR="43114,10,42220" ```
</TabItem>
...
<TabItem value="env" label="As Env">
  ```sh export HYP_ALLOWLOCALCHECKPOINTSYNCERS=false ```
</TabItem>
