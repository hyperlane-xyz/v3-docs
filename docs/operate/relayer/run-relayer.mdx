...
| `--chains.[originChainName].customGrpcUrls`     | Configure multiple gRPC endpoints for Cosmos chains, similar to `customRpcUrls`. |
| `--chains.[originChainName].rpcConsensusType`   | Defines how multiple RPC URLs are used. |
