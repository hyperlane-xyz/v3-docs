...
Hyperlane代理（验证器和中继器）必须配置私钥才能运行。验证器使用私钥签署[message checkpoints](../reference/glossary.mdx#checkpoint)，中继器使用私钥签署传递信息的事务。
...
1. 访问[AWS console](https://us-east-1.console.aws.amazon.com/iamv2/home) 中的AWS身份和访问管理(IAM)；
