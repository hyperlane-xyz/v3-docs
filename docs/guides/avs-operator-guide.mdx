...
To confirm you are registed on mainnet, run `hyperlane avs check --chain ethereum --operatorAddress<AVS_SIGNING_ADDRESS>` using the Hyperlane CLI and see if your validator address is there. This query may take a few minutes to complete.
