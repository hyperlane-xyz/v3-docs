...
By completing these steps, you've successfully removed the trusted relayer ISM from your Warp Route, enhancing the security of your warp route setup, and readiness for production use.