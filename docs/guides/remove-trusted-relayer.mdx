...
# How to Remove Trusted Relayer ISM from your Hyperlane Warp Route
...
You should be able to select the warp route that you wish to remove the trusted relayer for.
