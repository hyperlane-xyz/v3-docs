...
**Static module management** - Our Solidity implementation defines ISMs as static and part of the bytecode which might not be possible in other chains. You may need to implement dynamic modules for the ISM instead.
