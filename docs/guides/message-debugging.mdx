...
<details>
  ...
  <div>
    ...
    When viewing the origin transaction on the origin chain's block explorer, navigate the **Logs** tab.
    ...
    When viewing the origin transaction on the origin chain's block explorer, navigate the **Event Logs** tab.
