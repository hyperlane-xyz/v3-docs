...
:::tip
For further information, check out the [Validators guide](docs/operate/validators/run-validators.mdx). To learn about running multiple validators, see [this section](docs/operate/validators/run-validators.mdx#running-multiple-validators).
:::
