...
Validators provide the security for messages sent _from_ your chain to remote chains. They're only required when using a [Multisig ISM](../protocol/ISM/multisig-ISM.mdx). Learn more about what validators do [here](../protocol/agents/validators.mdx).
...
Relayers deliver interchain messages sent between the local and remote chains. Learn more about what relayers do [here](../protocol/agents/relayer.mdx).
