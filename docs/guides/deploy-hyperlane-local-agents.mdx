...
For further information, check out the [Validators guide](docs/operate/validators/run-validators.mdx).
...
For further information, check out the [Relayer guide](docs/operate/relayer/run-relayer.mdx).
