...
Here's an example config for a Warp Route that connects USDC on Sepolia to Alfajores. You can use Typescript, JSON, or YAML configs for your token configs.
