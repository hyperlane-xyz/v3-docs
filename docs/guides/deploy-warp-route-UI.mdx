...
Note, if any tokens or networks are missing after you've pasted in the YAML file, it's possible Superbridge doesn't support this network just yet. [Reach out](support@superbridge.app) to them to see what the timeline is for adding support.
