...
Here's an example of a token config for a Warp Route that connects WETH on Sepolia (chain ID 11155111). You can use Typescript, JSON, or YAML configs for your token configs.
