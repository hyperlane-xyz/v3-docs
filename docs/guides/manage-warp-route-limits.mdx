...
Warp Routes support [`xERC20` tokens](https://github.com/defi-wonderland/xERC20).

Here's how to configure `xERC20` for Warp Route usage:
...
- Set appropriate mint and burn limits for the Warp Route contract. This configuration must be done by the owner of the `xERC20` contract from the `setLimits` function.
