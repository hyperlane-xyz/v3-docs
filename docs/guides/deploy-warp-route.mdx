...
* _Optional:_ The token standard - this includes fungible tokens using ERC20 or NFTs using ERC721, as well as ERC4626 yield-bearing tokens. _Note:_ ERC721 support is experimental and some Hyperlane tooling won't work for NFTs yet.
