...
Alternatively, if you prefer to define your config manually, see the sections below. Otherwise you can skip to [deployment](#2-deployment).
...
To create a chain netadata config for any other chains, run the following command:
